...
**Generation:** The dashboard is generated by `.gse/dashboard.py` (Python script, no external dependencies except optional Chart.js via CDN). It parses all `.gse/*.yaml` files and `docs/sprints/` artefacts.

**Lifecycle integration:**

| Moment | Action |
|---|---|
| HUG (Step 5.5) | First generation — create `.gse/dashboard.py`, generate initial `docs/dashboard.html`, inform user |
| GO (Step 2.6) | Regenerate at session start (silent) + rattrapage if script missing |
...
**Usage:**
```bash
python3 .gse/dashboard.py              # generate once (CDN mode)
python3 .gse/dashboard.py --watch      # live updates on file changes
python3 .gse/dashboard.py --no-cdn     # offline mode
```
